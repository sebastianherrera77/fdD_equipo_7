...
Siguiendo VDI 2206, los requerimientos se clasifican en:
...
## 4. Trazabilidad
Este documento consolida los hallazgos de los Issues 1 a 5 (revisión normativa,
selección de variables, vinculación ODS y brecha diagnóstica), y sirve de
base para las etapas de conceptualización del sistema, en coordinación con
el resto del equipo.
